...
let transporter = nodemailer.createTransport({
    ...
    auth : {
        user : "1e862bce90175d",
        pass : "aeacab0f80aea5" //process.env.EMAILPASSWORD
    },
    tls : {
...
exports.signup = async(req, res) => {
   ...
   let HelperOptions ={
        ...
        to : user.email,
        subject : "Welcome to Readr",
        text : "Hello " + user.name + ", \n\nWelcome to Readr. This is a fully functional e-commerce app built on MERN stack along with payment gateway. \nAny suggestions are always welcome."
    };
